...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="main">  
            ...
            <form:form id="info_form" commandName="account"  action="update.from" 
                    ...
                    <div class="input_info">
                        ...
                        <div class="change_pwd">
                        	<input type="checkbox" id="chkModiPwd" onclick="showPwd(this);"/>
                    ...
                    <div class="input_info fee_type">
                    	<form:radiobutton path="gender" id="female" value="1" onclick="feeTypeChange(1);"/>
                        <label for="female">女</label>
                        <form:radiobutton path="gender" id="male" value="0" onclick="feeTypeChange(2);"/>

...
CREATE TABLE SERVICE(ID NUMBER(10) PRIMARY KEY,
...
ALTER SESSION SET NLS_DATE_FORMAT  = 'yyyy mm dd hh24:mi:ss'
INSERT INTO SERVICE VALUES (2001,1010,'192.168.0.26',
'guojing','guo1234',0,'2009 03 10 10:00:00',null,null,1);
...
-- { "guojing", "huangrong",
-- "luwus huang", "tongxiangyu", "baizhantang", "moxiaobei", 
